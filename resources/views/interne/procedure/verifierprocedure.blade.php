				...
				<div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
					...
					<div class="toolbar py-5 py-lg-15" id="kt_toolbar">
						...
						<div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap">
							<!--begin::Title-->
							<h3 class="text-white fw-bolder fs-2qx me-5">Vérifier procédure</h3>
							<!--begin::Title-->
							<!--begin::Actions-->
					...
					<!--end::Toolbar-->
                    <div class="forms">
						<form action="{{url('ajouter_verif',$procedure->id)}}" method="POST">
							@csrf
							<div class="row">
								<div class="col mb-3">
							...
							<div class="row">
								<div class="col mb-3">
									...
									<input type="date" name="date_verification" class="form-control" placeholder="Fonction" value="{{ $procedure->date_verification }}" required>
								</div>
