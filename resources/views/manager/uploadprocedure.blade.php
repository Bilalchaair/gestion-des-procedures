                            ...
                            <div class="menu-item px-5">
                                <div class="forms">
                                    ...
                                    <div class="labels">
                                        <label>service :</label>
                                        <select name="service"  >
                                            <option value="10">service de qualité et de gestion des risques</option>
                                            <option value="11">service d'enseignement de recherche et dinovation</option>
                                            <option value="12">service d'audit et de contrôle de gestion</option>
                                            <option value="9">service de communication de coopération et de part</option>
                                        </select>
                                    </div>
                                    <div >
