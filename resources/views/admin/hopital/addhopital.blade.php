				...
				<div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
					...
					<div class="toolbar py-5 py-lg-15" id="kt_toolbar">
						...
						<div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap">
							<!--begin::Title-->
							<h3 class="text-white fw-bolder fs-2qx me-5">Ajouter Hôpital</h3>
							<!--begin::Title-->
							<!--begin::Actions-->
					...
					<!--end::Toolbar-->
                <div class="forms">
                    <form action="{{url('add_hopital')}}" method="POST" enctype="multipart/form-data" class="select">
                        @csrf
                                    <div class="labels">
                                        <label>Nom d'hôpital :</label>
                                        <input type="text" name="nom_hopital">
                                    </div>
                                    <div class="labels">
                                        <label>Adresse :</label>
