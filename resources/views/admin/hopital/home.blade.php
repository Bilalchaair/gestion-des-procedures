...
<html lang="en">
    ...
    <body id="kt_body" style="background-image: url(adminassets/dist/assets/media/patterns/header-bg.png)" class="header-fixed header-tablet-and-mobile-fixed toolbar-enabled">
				...
				<div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
					...
					<div class="toolbar py-5 py-lg-15" id="kt_toolbar">
						...
						<div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap">
							<!--begin::Title-->
							<h3 class="text-white fw-bolder fs-2qx me-5">Gestion des hôpitaux</h3>
							<!--begin::Title-->
							<!--begin::Actions-->
							<div class="d-flex align-items-center flex-wrap py-2">
                                ...
                                <div >
									<span  >
									<a href="{{ route('addhopital') }}" >
									<span class="buttoncss" >Ajouter hôpital </span>
									</a>
								</span>	
								</div>
    				...
    				<tbody>
						...
						@else
						<tr>
							<td class="text-center" colspan="5">Aucun Hôpital Trouvé</td>
						</tr>
					@endif
        				<!-- and so on... -->
    				</tbody>
		...
		<div id="confirmationModal" class="modal">
			...
			<div class="modal-content">
				<h3>Confirmation</h3>
				<p>Etes-vous sûr(e) de vouloir supprimer cet Hôpital?</p>
	...
	var modal = document.getElementById('confirmationModal');
	modal.style.display = 'none';
	window.location.href = "{{ url('delete_hopital') }}/" + deleteId;
	}
	</script>
