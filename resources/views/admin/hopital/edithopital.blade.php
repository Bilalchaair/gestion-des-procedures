				...
				<div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
					...
					<div class="toolbar py-5 py-lg-15" id="kt_toolbar">
						...
						<div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap">
							<!--begin::Title-->
							<h3 class="text-white fw-bolder fs-2qx me-5">Modifier Hôpital</h3>
							<!--begin::Title-->
							<!--begin::Actions-->
					...
					<!--end::Toolbar-->
                    <div class="forms">
                    <form action="{{url('edit_hopital',$hopital->id)}}" method="POST" enctype="multipart/form-data" class="select">
                        @csrf
                                    <div class="labels">
                                        <label>nom d'hôpital :</label>
                                        <input type="text" name="nom_hopital" value="{{$hopital->nom_hopital}}">
                                    </div>
                                    <div class="labels">
                                        <label>Adresse :</label>
                                        <input type="text" name="adresse" value="{{$hopital->adresse}}">
                                    </div>
                                    <div >
