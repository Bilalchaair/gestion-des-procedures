				...
				<div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
					...
					<div class="toolbar py-5 py-lg-15" id="kt_toolbar">
						...
						<div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap">
							<!--begin::Title-->
							<h3 class="text-white fw-bolder fs-2qx me-5">Gestion des services</h3>
							<!--begin::Title-->
							<!--begin::Actions-->
							<div class="d-flex align-items-center flex-wrap py-2">
                                ...
                                <div >
									...
									<span class="buttoncss" >Ajouter service</span>
									</a>
								</span>	
								</div>
					...
					@endif
					<form action="{{ url('filter-service') }}" method="GET">
						<div class="form-group">
							<label for="division">Trier par Division :</label>
							<select name="divisionId" id="division" class="form-control" >
								<option value="" >Tous</option>
								@foreach($division as $division)
									<option value="{{ $division->id }}" @if($division->id == $divisionId) selected @endif>{{ $division->nom_division }}</option>
								@endforeach
							</select>
						</div>
