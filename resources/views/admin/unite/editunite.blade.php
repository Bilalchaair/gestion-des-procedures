				...
				<div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
					...
					<div class="toolbar py-5 py-lg-15" id="kt_toolbar">
						...
						<div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap">
							<!--begin::Title-->
							<h3 class="text-white fw-bolder fs-2qx me-5">Modifier unité </h3>
							<!--begin::Title-->
							<!--begin::Actions-->
					...
					<!--end::Toolbar-->
                <div class="forms">
                    <form action="{{url('edit_unite',$unite->id)}}" method="POST" enctype="multipart/form-data" class="select">
                        @csrf
                                    <div class="labels">
                                        <label>nom d'unité  :</label>
                                        <input type="text" name="nom_unite" value="{{$unite->nom_unite}}">
                                    </div>
                                    <div class="labels">
                                        <label> Service:</label>
